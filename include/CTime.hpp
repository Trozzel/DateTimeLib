...
public:
    ...
    // GETTERS
    [[nodiscard]] inline std::string getAscTime()    const;   /* seconds,  range 0 to 59          */
    [[nodiscard]] inline std::string getIso8610Str() const;   /* "YYYY-MM-DD HH:MM:SS"            */
    ...
    // STATIC METHODS
    static double getDiffTime(const CTime& ct1, const CTime& ct2);
